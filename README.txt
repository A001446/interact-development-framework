...
The framework has not been tested in the field and thus has not hit 1.0.
There are many enhancements to take on just with JavaScript - some low hanging and others are "pie in the sky".
Examples: hot module replacement, CI/CD, configure production (minified) builds, and many more.
...
To start the build and watch files: npm run build
